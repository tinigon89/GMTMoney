...
public class Constant {
	...
	public static final String kServer_Get_Search_Sender 			= "http://www.gmtmoney.com.au/isendersrch.aspx?regid=%s&lst=%i&data=%s";
	public static final String kServer_Get_Bene 					= "http://www.gmtmoney.com.au/ibenesrch.aspx?regid=%s&lst=-1&data=%s";
	public static final String kServer_Get_Search_Bene 				= "http://www.gmtmoney.com.au/ibenesrch.aspx?regid=%s&lst=%i&data=%s";
	public static final String kServer_Get_Search_Remitance 		= "http://www.gmtmoney.com.au/idupsrch.aspx?regid=%s&lst=%i&data=%s";
