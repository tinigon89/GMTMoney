...
public class Step4Activity extends BaseActivity {
	...
	private void initFields(){
		...
		step4_sender_nationally.setText("");
		step4_sender_companyname.setText(listSenderInfo.get(step2).getBisName());
		step4_sender_identification.setText(listSenderInfo.get(step2).getIdentyID());
		...
		step4_sender_postaladdress.setText("");
