...
+ (NSManagedObjectModel *)managedObjectModel{
    ...
    NSString *modelPath = [HOMEDIRECTORY stringByAppendingPathComponent:@"Hotfm.momd"];
...
+ (NSPersistentStoreCoordinator *)persistentStoreCoordinator 
{
    ...
    NSURL *storeURL = [NSURL fileURLWithPath:[LIBRARY_CATCHES_DIRECTORY stringByAppendingPathComponent: @"Hotfm.sqlite"]];
    NSLog(@"urlstring:%@", [LIBRARY_CATCHES_DIRECTORY stringByAppendingPathComponent: @"Hotfm.sqlite"]);
    NSError *error = nil;
